Ext.define('pharmacy.view.inventoryController', {
    ...
    loadAllinventory: async function () {
        let inventoryList = this.lookupReference('grdAllInventory');
        let response = await Ext.Ajax.request({ url: '/inventory', method: 'get' });
        if (response.responseText) {
